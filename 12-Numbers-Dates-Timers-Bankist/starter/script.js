...
//Random generation of numbers between 1 and 6
...
//BigInt
console.log(2837162435181023837193n);
console.log(BigInt(2837162435181023837193));

//Operations

console.log(10000000n + 2837162435181023837193n);

const huge = 2837162435181023837193n;
const num = 23;
...
console.log(new Date(2037, 10, 9));
...
const days1 = caclDaysPassed(new Date(2037, 3, 14), new Date(2037, 3, 24));
console.log(days1);
